...
- **Dynamic Tabs**: Plus button creates new NOTE that appears in a new tab (to the left of Scratch tab). The tab is created to display the note.
...
**Implementation:**
- Typing → Save locally immediately
- Stop typing for 2-3 seconds → Sync to Firebase
- Switch tab/notebook → Force sync immediately
- Offline → Queue syncs, execute when online
