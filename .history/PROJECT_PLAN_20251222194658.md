...
1. **"4 Staple Notes"**: What are these? Are they special notes that always exist? What makes them "staple"?
2. **Notebook Switching**: When you switch notebooks, does it save your current state? Can you have multiple notebooks open?
3. **Tab Icons**: What icons should each tab have? (Scratch, Now, Short-Term, Long-term)
4. **Note Movement**: When moving notes between tabs, is it drag-and-drop or menu-based?
5. **Locked Tabs**: Can you lock/unlock tabs, or are they locked by default? Which tabs should be locked?
6. **Default Tab State**: Should all 5 default tabs be unlocked initially?
7. **Notebook Naming**: Can notebooks be renamed? Do they have default names?
8. **Data Separation**: Are notebooks completely separate (can't see notes from other notebooks)?
