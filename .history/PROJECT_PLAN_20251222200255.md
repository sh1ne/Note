...
- ✅ **Dynamic Tabs**: Plus button creates NEW TABS (not just notes) to the left of Scratch tab
...
### Note Deletion
- **Confirmation Window**: Yes, shows confirmation popup before deleting
...
- **Auto-Save**: Everything auto-saves continuously, and when switching notebooks (see Auto-Save Strategy)
