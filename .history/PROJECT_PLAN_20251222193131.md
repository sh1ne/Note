...
### Bottom Navigation Tabs (Custom Design)
**Your Custom Tabs:**
...
**Features:**
- ✅ Tabs are **renamable** (stored in database)
- ✅ Each tab shows notes in that category
- ✅ Default to "Scratch" tab on app open
- ✅ Bottom navigation bar (like your screenshots)

**Questions to Clarify:**
- Can notes be moved between tabs? (Yes/No)
- Can users add/delete tabs? (Or fixed at 5?)
- What does each tab show? (List of notes in that category?)
- Should tabs have icons? (Or just text?)
