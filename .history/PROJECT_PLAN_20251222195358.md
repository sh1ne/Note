...
**Default Tabs (Renamable):**
1. **Tab 1 - "Scratch"** (default tab)
2. **Tab 2 - "Now"**
3. **Tab 3 - "Short-Term"**
4. **Tab 4 - "Long-term"**
5. **Tab 5 - "More"** (not "Settings")

**Tab Features:**
- ✅ All tabs are **renamable**
- ✅ Tabs can be **locked or unlocked**
  - **Locked tabs**: Notes cannot be moved out of them
  - **Unlocked tabs**: Notes can be moved between tabs
- ✅ **Add/Delete tabs**: If tab is unlocked, click it to get options menu
