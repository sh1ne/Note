...
1. **"4 Staple Notes"**: What are these? Are they special notes that always exist? What makes them "staple"? Do they appear in all notebooks or just one?
2. **Notebook Switching**: When you switch notebooks, does it save your current state automatically? Can you have multiple notebooks open at once?
3. **Tab Icons**: What icons should each tab have? (Scratch, Now, Short-Term, Long-term, More) - or should I pick appropriate icons?
4. **Note Movement**: When moving notes between tabs, is it drag-and-drop or menu-based (long press → menu)?
5. **Locked Tabs**: Can you lock/unlock tabs yourself, or are they locked by default? Which tabs should be locked initially (if any)?
6. **Default Tab State**: Should all 5 default tabs be unlocked initially, or should some be locked?
7. **Notebook Naming**: Can notebooks be renamed? Do they have default names like "Notebook 1", "Notebook 2"?
8. **Data Separation**: Are notebooks completely separate (can't see notes from other notebooks when in one)?
9. **Note List Behavior**: When you click a note from the "all notes" list and it temporarily goes to Tab 1 - does it stay there permanently after you close it, or go back to its original tab?
10. **Tab Options Menu**: When you click an unlocked tab to get options (add/delete), what other options should be there? (Rename? Lock/Unlock? Change icon?)

### Additional Features to Consider for "More" Tab:
- **Force Update to Cloud** ✅ (you mentioned)
- **Account/Profile** ✅
- **Theme Selection** ✅ (Dark/Light/Purple/Blue)
- **Export Notes** ✅
- **Notebook Management** ✅
- **App Settings** (notifications, auto-save frequency, etc.)
- **About/Help** section
- **Data & Storage** (see how much space used)
