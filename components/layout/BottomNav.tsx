...
export default function BottomNav({
  ...
  return (
    <nav className="fixed left-0 right-0 bg-bg-primary border-t border-bg-secondary z-50 rounded-t-2xl overflow-hidden" style={{ bottom: 'max(env(safe-area-inset-bottom, 0px), 16px)' }}>
