...
export default function BottomNav({
  ...
  return (
    <nav className="fixed left-0 right-0 bg-bg-primary border-t border-bg-secondary z-50 overflow-hidden" style={{ borderRadius: 0, bottom: '-4px', minHeight: '56px' }}>
      <div className="flex items-center justify-around h-14 px-1" style={{ paddingBottom: 'env(safe-area-inset-bottom, 0px)', minHeight: '56px' }}>
        <button
        ...
        {sortedTabs.map((tab) => {
          ...
          return (
            <button
              ...
              type="button"
              className={`flex flex-col items-center justify-center h-12 text-text-primary hover:bg-bg-secondary rounded min-w-0 flex-shrink-0 ${
